...
M.configure_highlights = function()
  ...
  hi(0, "TSConstant", { fg = color.lavender, italic = true })
  ...
  hi(0, "TSVariableBuiltin", { fg = color.burnt_orange })
